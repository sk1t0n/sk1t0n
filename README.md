...
**Other**: WezTerm, Obsidian, Bruno, DBeaver, Docker & Docker Compose, Nginx, Valkey, RustFS, Meilisearch, RabbitMQ/NATS, Prometheus, Grafana, Grafana Loki, Grafana Alloy, Sentry, Uptime Kuma etc
